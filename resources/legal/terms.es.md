...
El sistema ofrece demostraciones, ejemplos y tutoriales para el uso de un framework basado en Laravel, con fines educativos y de aprendizaje para desarrolladores.
...
El correo electrónico se utiliza exclusivamente para:

* identificar al usuario dentro de la plataforma
* permitir la recuperación de contraseña en caso de olvido
* enviar, de forma opcional, notificaciones o novedades relacionadas con la plataforma
...
* actividades automatizadas no autorizadas (bots o scripts)
* generación de contenido malicioso o que afecte el funcionamiento del sistema
* cuentas inactivas durante períodos prolongados de tiempo
